...
namespace MediatR.Extensions.FluentBuilder.Tests
{
    public class TestRequest : IRequest<TestResponse>
    {
        ...
        internal class Module : RequestModule<TestRequest, TestResponse>
        {
            public override IExceptionsPipelineBuilder<TestRequest, TestResponse> BuildPipeline(IPipelineBuilder<TestRequest, TestResponse> builder)
            {
